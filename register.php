...
<body>
<div id="banner">
<span class="head"><center>E-Library for CSE and IT</center></span><br />
<marquee class="clg" direction="right" behavior="alternate" scrollamount="1">Heyy!!You are taking a very good step in the process of Learning.Go Ahead.... </marquee>
</div>
<br />
...
<span class="SubHead">Register Here..</span>
<br />
<br />
...
<option value="0">Faculty/Instructor</option>
...
<option value="Information Technology">Other branch</option>
</select>
</td></tr>
<tr><td class="labels">Member ID : </td><td><input type="text" name="sid" class="fields" placeholder="Enter ID" required="required" size="25" /></td></tr>
