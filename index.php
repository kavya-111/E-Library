...
<body>
<div id="banner">
<span class="head"><center>E-Library for CSE and IT</center></center></span><br />
...
<span class="SubHead">Member Sign In</span>
<br />
<br />
<form method="post" action="">
<table border="0" cellpadding="4" cellspacing="4" class="table">
<tr><td colspan="2" align="center" class="msg"><?php echo $msg;?></td></tr>
<tr><td class="labels">Member ID : </td><td><input type="text" name="sid" class="fields" size="25" placeholder="Enter ID" required="required" /></td></tr>
