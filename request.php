...
$ba=$_POST['author'];
$fb=$_POST['Feedback'];
if($bn!=NULL && $ba!=NULL && $fb!=NULL)
{
	$sql=mysqli_query($set,"INSERT INTO request(name,author,Feedback,sid) VALUES('$bn','$ba','$fb',$sid')");
	if($sql)
	{
		$msg="Successfully Requested....we'll upload it soon.please check later for the book.";
	}
	else
	{
...
<table border="0" class="table" cellpadding="10" cellspacing="7">
...
<tr><td colspan="2" align="center"><input type="submit" class="fields" value="Convey msg!!" /></td></tr>
</table>
</form>
